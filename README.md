...
# 🔄 Workflow (Based on Execution Steps)

This is the **actual sequence followed during execution (26 steps):**

1. Open system → *Welcome page displayed*  
2. Select user option  
3. Register new user  
4. Choose login option  
5. Login successfully  
6. Submit a print request  
7. Buy a prepaid package  
8. Try print using prepaid *(before approval)*  
9. Check history → *empty (not approved yet)*  
10. Check prepaid → *not available yet*  
11. Logout  

12. Register as admin  
13. Login as admin  
14. View pending print requests  
15. Approve / Reject print request  
16. View completed requests  
17. Approve / Reject prepaid requests  
18. View all prepaid packages  
19. Logout admin  

20. Login again as user  
21. View approved print history  
22. View approved prepaid packages  
23. Submit new request using prepaid  
24. Admin approves new request  
25. User checks updated history  
26. User checks rejected request status  
...
## 20) Loading as User to see Approved printing requests & prepaid packages :
...
## 21) See printing History (Admin approved requests)
<img width="1280" height="417" alt="Screenshot 2026-04-29 at 10 06 02 PM" src="https://github.com/user-attachments/assets/0627d1cb-0572-4183-bd34-a1f7e3197adb" />
...
## 23) Submit print request with prepaid package:
...
## 24) Admin approves prepaid request:
...
## 26) Check rejected request status:
